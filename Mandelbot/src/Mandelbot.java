	...
	/*
	   This applet draws a representation of the famous Mandelbot
	...
	*/
	...
	public class Mandelbot extends JApplet {

	   Display canvas;  // The drawing surface on which the Mandelbot
	                    // set is displayed.
	   ...
	   class Display extends JPanel implements ActionListener, Runnable {
	      ...
	      Image OSI;    // An off-screen images that holds the picture
	                    //    of the Mandelbot set.  This is copied onto
